      ...
      content: (
        <div className="space-y-6">
          {[
            ...
            { q: "How does the payment process work?", a: "Made-in-US.com acts as a secure escrow service. The buyer sends payment to our company, which holds the funds during the transaction. Once the purchase is confirmed, we release the payment to the seller. Our escrow fee is $350." },
        ...
        <div className="space-y-8 max-h-[70vh] overflow-y-auto pr-4 custom-scrollbar">
          {[
            ...
            { 
              ...
              c: "We provide a secure escrow service for transactions. Buyers send funds to our designated company account, and we hold them until the purchase is confirmed. A non-refundable escrow fee of $350 applies to each transaction." 
            },
            { 
